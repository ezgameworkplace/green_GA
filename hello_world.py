...
def get_in_game(connection, package_name, package_main_activity_name):
    connection.reboot()
    time.sleep(20)  # FIXME 等待手机activity
...
if __name__ == '__main__':
    ...
    port1 = '60025'  # 本地端口1
    port2 = '60026'  # 本地端口2
    serial1 = '127.0.0.1:62040'  # adb设备号1
    serial2 = '127.0.0.1:62041'  # adb设备号2
    nox1 = '62040'  # 模拟器名称1
    nox2 = '62041'  # 模拟器名称2
    ...
    c2 = UnitySDK(ip, port2, serial2, real_phone=True, width_dif=100, height_dif=0, package_name=package_name,
